...
class HttpServer(unittest.TestCase):
  ...
  def test_empty_request(self):     #OK
    """ Send empty line """
  ...
  def test_request_without_two_newlines(self):      #OK
  ...
  def test_server_header(self):     #OK
  ...
  def test_index_not_found(self):
    ...
    self.conn.request("GET", "/httptest/dir1/")     #OK
    r = self.conn.getresponse()
    data = r.read()
    self.assertEqual(int(r.status), 403)

  def test_file_not_found(self):    #OK
  ...
  def test_file_in_nested_folders(self):    #OK
  ...
  def test_file_with_query_string(self):    #OK
  ...
  def test_file_with_spaces(self):  #OK
  ...
  def test_file_urlencoded(self):   #OK
    """urlencoded filename"""
  ...
  def test_document_root_escaping(self):    #OK
  ...
  def test_file_with_dot_in_name(self):     #OK
